...
.v5-env { min-height: 32px; padding: 6px 11px !important; font-size: 12px !important; }
...
.v5-icon-button { width: 40px !important; height: 38px !important; font-size: 19px !important; }
.v5-more summary { width: 42px !important; height: 38px !important; font-size: 16px !important; }
.v5-more-menu { top: 44px !important; width: 190px !important; }
.v5-more-menu button { min-height: 38px !important; height: 38px !important; font-size: 13px !important; }
...
.billing-badge, .usage-24h, .runtime-route-badge { min-height: 26px !important; padding: 4px 9px !important; font-size: 11px !important; }
.v5-github { height: 34px !important; padding: 0 10px !important; font-size: 12px !important; }
.v5-github-mark { font-size: 11px !important; }
.session-id { max-width: 125px !important; flex-basis: 125px !important; font-size: 11px !important; }
...
.v5-welcome-grid { font-size: 13px !important; gap: 10px 22px !important; }
.chat-message { width: min(920px, calc(100% - 54px)) !important; }
.message-meta { min-height: 32px; gap: 7px !important; font-size: 12.5px !important; }
.message-model { padding: 4px 9px !important; }
.message-bubble { font-size: 17px !important; line-height: 1.65 !important; }
.message-copy, .code-copy, .message-materialise { min-height: 30px !important; padding: 0 9px !important; font-size: 12px !important; cursor: pointer !important; }
.v5-composer { width: min(920px, 100%) !important; }
.v5-composer textarea { min-height: 66px !important; padding: 16px 17px 8px !important; font-size: 17px !important; }
...
.v5-model-picker select { height: 40px !important; padding: 0 34px 0 12px !important; font-size: 14px !important; }
.v5-attach, .v5-stop, .v5-send { min-height: 40px !important; height: 40px !important; }
.v5-attach { width: 40px !important; font-size: 20px !important; }
.v5-send { width: 42px !important; font-size: 20px !important; }
.v5-route-note { width: min(920px, 100%) !important; font-size: 11.5px !important; }
...
.v5-terminal-title strong { font-size: 14px !important; }
.v5-terminal-title small { font-size: 11px !important; }
.hermes-state { padding: 4px 8px !important; font-size: 11px !important; }
.v5-mini-button { min-height: 34px !important; height: 34px !important; padding: 0 10px !important; font-size: 12px !important; }
.v5-terminal-composer { grid-template-columns: minmax(0, 1fr) 42px !important; gap: 8px !important; padding: 9px !important; }
.v5-terminal-composer textarea { min-height: 44px !important; padding: 11px 12px !important; font-size: 14px !important; }
.v5-terminal-send { width: 42px !important; height: 44px !important; font-size: 20px !important; }
.hermes-hint { font-size: 12px !important; }
...
.history-item-title { font-size: 15px !important; }
.history-item-meta, .history-empty { font-size: 12.5px !important; }
.github-chat-consent-dialog { font-size: 15px !important; }
.github-chat-consent-dialog button { min-height: 38px; font-size: 13px; }
.router-toggle { min-height: 38px !important; font-size: 13px !important; }
.router-kicker, .router-label, .router-live { font-size: 11px !important; }
.router-title-row h2 { font-size: 20px !important; }
.router-action { min-height: 36px !important; height: 36px !important; font-size: 12px !important; }
.router-request { font-size: 16px !important; }
.router-chip { font-size: 12px !important; padding: 5px 8px !important; }
.router-signal { font-size: 13px !important; padding: 9px 10px !important; }
.router-signal strong, .router-agent strong { font-size: 12px !important; }
.router-agent span { font-size: 11px !important; }
.router-event { font-size: 12px !important; }
.router-disclaimer { font-size: 12px !important; }
...
export function patchV5Js(source) {
  const replacements = [
    ...
    ['color:#d9e2e8;font-size:12px;', 'color:#d9e2e8;font-size:14px;'],
    ['.v5-model-role{height:34px;', '.v5-model-role{height:40px;'],
    ['color:#9fb0bb;font-size:11px;', 'color:#9fb0bb;font-size:13px;'],
    ['bottom:40px;', 'bottom:46px;'],
    ['font:600 12px/1.25', 'font:600 14px/1.3'],
    ['color:#687986;font-size:10px', 'color:#687986;font-size:12px'],
    ['font-size:8px;letter-spacing:.04em', 'font-size:10px;letter-spacing:.04em'],
    ['font-size:11px;text-align:center', 'font-size:13px;text-align:center']
  ];
  let next = source;
...
function selfTest() {
  ...
  const v5js = '.v5-model-search{width:170px;height:34px;color:#d9e2e8;font-size:12px;.v5-model-role{height:34px;color:#9fb0bb;font-size:11px;bottom:40px;font:600 12px/1.25;color:#687986;font-size:10px;font-size:8px;letter-spacing:.04em;font-size:11px;text-align:center';
  const v5Patched = patchV5Js(v5js);
  if (!v5Patched.includes("height:40px") || !v5Patched.includes("font-size:14px")) throw new Error("V5_READABLE_V5_JS_SELF_TEST_FAILED");
